          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid sm:grid-cols-3 gap-4">
              <div className="flex items-center gap-3 p-4 rounded-xl bg-slate-100 border border-slate-200">
                ...
                <div>
                  <div className="text-sm font-medium text-slate-900">Tecnici</div>
                  <div className="text-xs text-slate-600">Necessari</div>
                </div>
              </div>
              <div className="flex items-center gap-3 p-4 rounded-xl bg-slate-100 border border-slate-200">
                ...
                <div>
                  <div className="text-sm font-medium text-slate-900">Analitici</div>
                  <div className="text-xs text-slate-600">Statistiche</div>
                </div>
              </div>
              <div className="flex items-center gap-3 p-4 rounded-xl bg-slate-100 border border-slate-200">
                ...
                <div>
                  <div className="text-sm font-medium text-slate-900">Preferenze</div>
                  <div className="text-xs text-slate-600">Opzionali</div>
                </div>
              </div>
            </div>
          </div>
